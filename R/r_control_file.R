...
#' @param item1 The numeric location of the first item in your dataset
#' @param ni The number of items you want to add to the control file
#' @param id_col The name of the column where person names are located
#' @param groups Optional. String input for addings a ISGROUPS line.
